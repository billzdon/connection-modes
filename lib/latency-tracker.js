...
function checkThrottleLocations(position, locations, connectionMode) {
  locations.forEach(function(location) {
    if (position && connectionMode != c.NORMAL_LOADING && locations && distance(position.latitude, position.longitude, location.latitude, location.longitude) < location.radius) {
      connectionMode = c.LOW_CONNECTION;
    }
  })
